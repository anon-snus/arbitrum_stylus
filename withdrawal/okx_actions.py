...
from libs.py_okx_async.asset.models import TransferTypes, Currency
from libs.py_okx_async.models import OKXCredentials, AccountTypes

class OKXActions:
    def __init__(self, credentials: OKXCredentials, proxy: str = None):
        self.entrypoint_url = 'https://www.okx.com'
        self.credentials = credentials
        self.proxy = proxy
        self.okx_client = None
        if self.credentials.completely_filled():
            self.okx_client = OKXClient(credentials=credentials, entrypoint_url=self.entrypoint_url, proxy=self.proxy)
